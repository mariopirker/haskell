...
action_11 (12) = happyShift action_15
...
action_20 (11) = happyShift action_14
...
happyReduction_4 (HappyTerminal (TokInt happy_var_3))
	_
	(HappyAbsSyn7  happy_var_1)
	 =  HappyAbsSyn7
		 (Pow happy_var_1 (Nat happy_var_3)
	)
...
happyReduction_9 ((HappyTerminal (TokInt happy_var_5)) `HappyStk`
	_ `HappyStk`
	_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn7
		 (Bra (Pow happy_var_2 (Nat happy_var_5))
	) `HappyStk` happyRest

happyReduce_10 = happySpecReduce_1  7 happyReduction_10
happyReduction_10 (HappyTerminal (TokVar happy_var_1))
	 =  HappyAbsSyn7
		 (Var 1 happy_var_1
	)
...
happyReduction_11 (HappyTerminal (TokVar happy_var_2))
	(HappyTerminal (TokInt happy_var_1))
	 =  HappyAbsSyn7
...
happyReduction_12 ((HappyTerminal (TokVar happy_var_4)) `HappyStk`
	_ `HappyStk`
	(HappyTerminal (TokInt happy_var_2)) `HappyStk`
	_ `HappyStk`
	happyRest)
	 = HappyAbsSyn7
		 (VarR (Root happy_var_2) happy_var_4
	) `HappyStk` happyRest
...
happyNewToken action sts stk (tk:tks) =
	...
	TokVar happy_dollar_dollar -> cont 18;
	_ -> happyError' (tk:tks)
	}
...
eqparse tks = happyRunIdentity happySomeParser where
